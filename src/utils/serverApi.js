class ServerApi {
  ...
  getAuthCode(id) {
    return this.request(`${this.baseUrl}/getAuthCode/${id}`);
  }

  checkAuthCode(id, code) {
    return this.request(`${this.baseUrl}/checkAuthCode/${id}/${code}`);
  }
}

const serverApi = new ServerApi("https://sms.api.lecture.hufs.app");
